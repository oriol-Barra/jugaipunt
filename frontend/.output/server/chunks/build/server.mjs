...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import('./about-miMejZ-E.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-BJcmOXPI.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-C4gHMDwr.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-B3m2CDmj.mjs')
  },
  {
    name: "tournaments",
    path: "/tournaments",
    component: () => import('./tournaments-90wDVlbo.mjs')
  }
];
...
const layouts = {
  default: () => import('./default-BXNDgm5r.mjs')
};
